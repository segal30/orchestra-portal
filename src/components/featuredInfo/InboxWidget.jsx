...
import { InboxHtml } from "../pages/inbox/InboxHtml";
// import ModalCompose from "./ModalCompose";
import ModalMessage from "../pages/inbox/ModalMessage";
import messages from "../pages/inbox/messages.json";

import "./inboxWidget.scss";


export class InboxWidget extends Component {
  constructor(props) {
    super(props);
